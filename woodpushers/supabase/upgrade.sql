-- ChessMates UPGRADE script: everything AFTER the original 0001-0004 schema.
-- For a database that already has the base tables (yours). Safe to re-run
-- end to end, including after partial failures.
...
-- ===== supabase/migrations/0020_pin_photos.sql =====
...
-- ===== supabase/migrations/0021_admin_enrich_badges.sql =====
...
-- ===== supabase/migrations/0022_events.sql =====
...
-- ===== supabase/migrations/0023_enrich_pending.sql =====
...
-- ===== supabase/migrations/0024_follows.sql =====
