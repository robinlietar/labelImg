-- WoodPushers consolidated schema for a FRESH, EMPTY database.
-- If your database already has the base tables (cities, places, profiles...),
-- run supabase/upgrade.sql instead: this file cannot re-run over them.
